import { PPT_TEMPLATE_HIDDEN_PRESETS_KEY, PPT_TEMPLATE_UPLOADS_KEY } from "@/workspaces/ppt/workspace/constants";
import { deriveTextElementsFromBlocks, hasRenderableTextBlocks } from "@/workspaces/ppt/workspace/slide-content";
import type {
  SlideData,
  SlideImageVersion,
  SlideMaterialImage,
