...
import cadBomPromptTemplate from "@prompts/cad/bom-prompt.md?raw";
import cadImagesMasterRenovationSchemeTemplate from "@prompts/cad/images-agents/master-renovation-scheme.md?raw";
import cadRenovationPlanLayoutTemplate from "@prompts/cad/images-agents/renovation-plan-layout.md?raw";
import cadFloorFinishPlanTemplate from "@prompts/cad/images-agents/floor-finish-plan.md?raw";
import cadReflectedCeilingPlanTemplate from "@prompts/cad/images-agents/reflected-ceiling-plan.md?raw";
import cadWallSettingOutPlanTemplate from "@prompts/cad/images-agents/wall-setting-out-plan.md?raw";
import cadMepPlanTemplate from "@prompts/cad/images-agents/mep-plan.md?raw";
import cadElevationIndexAndInteriorElevationsTemplate from "@prompts/cad/images-agents/elevation-index-and-interior-elevations.md?raw";
import cadDetailDrawingsTemplate from "@prompts/cad/images-agents/detail-drawings.md?raw";
import cadOverallAnalysisBoardTemplate from "@prompts/cad/images-agents/overall-analysis-board.md?raw";
import cadKeyStrategyBoardTemplate from "@prompts/cad/images-agents/key-strategy-board.md?raw";
